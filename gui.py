...
# -----------------------------------------
    ...
    def _show_about_dialog(self) -> None:
        ...
        text = (
            ...
            "cable tray, SLD or schedule of loads Excel sheet held together with spiderwebs, dreams and duct tape "
            ...
            "<li>You were given formulas written by someone with a learning disability.</li>"
            ...
            "<li>Outputs a CSV report for when some cunt still wants to use Excel.</li>"
            "</ul>"
            "<br>"
